package co.id.rikihikmianto.mydeepnavigation
...
import co.id.rikihikmianto.mydeepnavigation.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        val notifDetailntent = Intent(this, DetailActivity::class.java)
        notifDetailntent.putExtra(DetailActivity.EXTRA_TITLE, title)
        notifDetailntent.putExtra(DetailActivity.EXTRA_MESSAGE, message)

        val pendingIntent = TaskStackBuilder.create(this)
            .addParentStack(DetailActivity::class.java)
            .addNextIntent(notifDetailntent)
